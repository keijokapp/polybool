...
function compareEvents(eventA, eventB) {
	...
	if (eventA.isStart) {
		return eventB.isStart
			? orient2d(eventB.seg.data.p1, eventA.seg.data.p1, eventA.seg.data.p0)
			: 1;
	}

	return eventB.isStart
		? -1
		: orient2d(eventB.seg.data.p0, eventA.seg.data.p1, eventA.seg.data.p0);
}
